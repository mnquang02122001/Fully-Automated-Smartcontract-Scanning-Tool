      ...
      <Row>
        <Col md="4" className="d-flex flex-column align-items-center">
          ...
          <p className="text-center fs-5">
            Choose your platform and paste the address of your smart contract
            into the field.
          </p>
        </Col>
        <Col md="4" className="d-flex flex-column align-items-center">
          ...
          <p className="text-center fs-5">
            Click on the search button. Our system will run an automated scan to
            identify vulnerabilities in your smart contract.
          </p>
        </Col>
        <Col md="4" className="d-flex flex-column align-items-center">
          ...
          <p className="text-center fs-5">
            When the scan completes, the system will produce a detailed analysis
            report. Check the report to see all vulnerabilities that need
